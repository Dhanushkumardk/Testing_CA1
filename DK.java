...
public class DK {
    public static void main( String[] args ) throws InterruptedException
    {
        ...
        driver.get("https://amzn.eu/d/1WEvPqK");
        driver.manage().window().maximize();
        String title = driver.getTitle();
        String etitle = "(Renewed) Redmi Note 7 Pro (Space Black, 128GB, 6GB RAM)";
        ...
        driver.get("https://www.amazon.in/dp/B08D9KQTSV?ref_=cm_sw_r_cp_ud_dp_3CX295TEZRK8MCBMGESJ");
        driver.findElement(By.xpath("//*[@id=\"add-to-cart-button\"]")).click();
        Thread.sleep(2000);
        driver.get("https://www.amazon.in/gp/cart/view.html/ref=dp_atch_dss_cart?");
        Thread.sleep(5000);
